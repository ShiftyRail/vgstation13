...
/datum/preference_setting/enum/headset_sound
	...
	allowed_values = list(HEADSET_SOUND_DISABLED, HEADSET_SOUND_TRANSMIT, HEADSET_SOUND_ALL)

/datum/preference_setting/enum/headset_sound/choose_setting(var/mob/user)
