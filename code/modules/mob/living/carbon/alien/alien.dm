...
/mob/living/carbon/alien/proc/updatePlasmaHUD()
	if(hud_used)
		...
		hud_used.vampire_blood_display.maptext = "<div align='left' valign='top' style='position:relative; top:0px; left:6px'> <font size='4'> P:<font color='#E9DAE9' size='4'>[plasma]</font><br>  / <font color='#BE7DBE' size='4'>[max_plasma]</font></font></div>"
	return
